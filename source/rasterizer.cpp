...
//	}
//
//    static std::vector<uint32_t> compileGLSLToSPIRV(const std::string& source, shaderc_shader_kind kind, const char* shaderName = "shader.glsl")
//    {
...
//        }
//
//        bool hasRequiredDeviceFeatures = deviceFeatures.geometryShader;
//
...
//    {
//        auto vertShaderGLSL = Shader::readShaderFile("C:/Users/Bennett/source/repos/VoxelEngine/shaders/shader.vert");
//        auto fragShaderGLSL = Shader::readShaderFile("C:/Users/Bennett/source/repos/VoxelEngine/shaders/shader.frag");
//
//        auto vertShaderSPIRV = Shader::compileGLSLToSPIRV(vertShaderGLSL, shaderc_glsl_vertex_shader, "Vertex Shader");
//        auto fragShaderSPIRV = Shader::compileGLSLToSPIRV(fragShaderGLSL, shaderc_glsl_fragment_shader, "Fragment Shader");
//
//        VkShaderModule vertShaderModule = Shader::createShaderModule(device, vertShaderSPIRV);
//        VkShaderModule fragShaderModule = Shader::createShaderModule(device, fragShaderSPIRV);
//
//        VkPipelineShaderStageCreateInfo vertShaderStageInfo{};
//		vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
//		vertShaderStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
//        vertShaderStageInfo.module = vertShaderModule;
//		vertShaderStageInfo.pName = "main"; // specify the entry point
//        vertShaderStageInfo.pSpecializationInfo = nullptr; // For setting constants at pipeline creation
//
//        VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
//		fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
//		fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
//		fragShaderStageInfo.module = fragShaderModule;
//		fragShaderStageInfo.pName = "main"; // specify the entry point
//        fragShaderStageInfo.pSpecializationInfo = nullptr; // For setting constants at pipeline creation
//
...
//        fenceInfo.flags = VK_FENCE_CREATE_SIGNALED_BIT; // Make sure the fence starts in signaled state so the first frame can render
//
...
//    }
//   
//    inline void cleanupSynchronizationObjects()
//    {
//        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) 
//        {
